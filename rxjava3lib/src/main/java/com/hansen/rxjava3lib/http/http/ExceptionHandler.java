package com.hansen.rxjava3lib.http.http;
...
public class ExceptionHandler {
    ...
    public static ResponseException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            ex = new ResponseException(e, SYSTEM_ERROR.HTTP_ERROR);
            ...
            ex = new ResponseException(e, SYSTEM_ERROR.PARSE_ERROR);
            ex.message = "解析错误";
            return ex;
        } else if (e instanceof ConnectException) {
            ex = new ResponseException(e, SYSTEM_ERROR.NETWORD_ERROR);
            ex.message = "连接失败";
            return ex;
        } else if (e instanceof javax.net.ssl.SSLException) {
            ex = new ResponseException(e, SYSTEM_ERROR.SSL_ERROR);
            ex.message = "证书验证失败";
            return ex;
        } else if (e instanceof ConnectTimeoutException) {
            ex = new ResponseException(e, SYSTEM_ERROR.TIMEOUT_ERROR);
            ex.message = "连接超时";
            return ex;
            ...
            ex = new ResponseException(e, SYSTEM_ERROR.UNKNOWN);
            ex.message = "未知错误";
            return ex;
        }
