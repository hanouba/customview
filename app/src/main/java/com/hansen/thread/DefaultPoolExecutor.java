...
import com.hansen.utils.TextUtils;
...
public class DefaultPoolExecutor extends ThreadPoolExecutor {
    ...
    private DefaultPoolExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime,
        ...
        super(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue, threadFactory,
            ...
            public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
                AHansen.logger.error(Consts.TAG, "Task rejected, too many task!");
            }
        });
    }
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        ...
        if (t != null) {
            AHansen.logger.warning(Consts.TAG, "Running task appeared exception! Thread [" +
